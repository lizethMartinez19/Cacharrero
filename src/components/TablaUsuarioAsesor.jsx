const TablaUsuarioAsesor = ({ data, deleteUser, getIdUser }) => {
                    ...
                    {data.map(respuesta => {
                        ...
                        return (
                            <tr key={respuesta.id}>
                                ...
                                <td><button type="button" href="#exampleModal" data-bs-toggle="modal" data-bs-target="#exampleModal" onClick={getIdUser(respuesta.id)} className="btn btn-success btn-block">EDITAR</button></td>
                            </tr>
                        )
                    })}
                </tbody>
...
export default TablaUsuarioAsesor