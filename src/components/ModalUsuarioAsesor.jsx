...
const ModalUsuarioAsesor = ({ updateUser, salesman }) => {
                        ...
                        <div className="form">
                            <div className="row mb-3 justify-content-center d-block px-5">
                                <div className="">
                                    ...
                                    <input type="datetime" name='birthtDay' value={information.birthtDay || ''} onChange={handleOnChange} className="form-control" id="usuarioBirth" />
                                </div>
                            </div>
                        </div>
                    </div>
...
export default ModalUsuarioAsesor