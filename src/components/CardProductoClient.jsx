...
const CardProductoClient = ({ consultar }) => (
            ...
            <div className="col-lg-12">
                <div className="card text-center">
                    ...
                    <div className="card-body">
                        <h5 className="card-title">CLIENTE| PRODUCTOS</h5>
                        <div className="row mt-5">
                        ...
                        <div className="row ">
                            ...
                            <div className="col-6">
                                <button type="button" href="#filtroDescription"  data-bs-toggle="modal" data-bs-target="#filtroDescription"  className="btn btn-danger btn-block">FILTRAR POR DESCRIPCIÓN</button>
                            </div>
                        </div>
                    </div>
...
export default CardProductoClient