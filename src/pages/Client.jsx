import CardProductoClient from '../components/CardProductoClient';
import TablaProductoClient from '../components/TablaProductoClient';
...
const Client = () => {
    ...
    return (
        <>
            <CardProductoClient consultar={consultar} />
            <TablaProductoClient data={data} deleteProduct={deleteProduct} getIdProduct={getIdProduct} />
